...
while True:
    ...
    if len(lmlist)!=0:
        ...
        if fingers[1] == 1 and fingers[2] == 1 and kt!= fingers[2]:
            pyautogui.click()
        kt=fingers[2]
#        if fingers[1] == 1 and fingers[2] == 1 and fingers[0] == 0 and fingers[3] == 0 and fingers[4] == 0:     # If fore finger & middle finger both are up
